                    ...
                    >
                        <div className="max-w-[554px] min-h-[313px] flex flex-col justify-between">
                            <div className="space-y-10">
                                <InfoRow 
                                    icon={<Phone className="w-8 h-8 text-black fill-black" />}
                                    text="(031) 732-1336"
                                />
                                <InfoRow 
                                    icon={
                                    ...
                                    text="+62 812-1671-6689"
                                />
                                <InfoRow 
                                    icon={<Mail className="w-8 h-8 fill-black text-white" strokeWidth={1.5} />}
                                    text="info@gkidamai.org"
                                />
                                ...
                                <div className="flex gap-5 items-start">
                                    <div className="mt-1 shrink-0">
                                        <MapPin className="w-8 h-8 fill-black text-white" strokeWidth={1.5} />
                                    </div>
                                    <div className="text-[#1a1a1a]">
                                        <p className="font-bold text-lg leading-relaxed">Jl. Raya Pradah Indah No.9, Lontar</p>
