            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 lg:gap-8">
                ...
                <div className="flex flex-col text-white lg:col-span-2 pr-0 lg:pr-8">
                    <div className="flex items-center gap-3 mb-6">
                        <img src="/images/home/logo-only.webp" alt="GKI Logo" className="w-10 h-10 object-contain" />
                    ...
                    <ul className="space-y-4 text-xs font-medium opacity-90">
                        <li className="flex items-center gap-3">
                            <a href="tel:0317321336" className="flex items-center gap-3 hover:text-white transition-colors group">
                                <Phone size={16} className="group-hover:scale-110 transition-transform" />
                                <span>(031) 732-1336</span>
                            </a>
                        </li>
                        <li className="flex items-center gap-3">
                            <a href="https://wa.me/6281216716689" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 hover:text-white transition-colors group">
                        ...
                        <li className="flex items-center gap-3">
                            <a href="mailto:info@gkidamai.org" className="flex items-center gap-3 hover:text-white transition-colors group">
